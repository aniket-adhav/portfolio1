...
export const meta = () => {
  return baseMeta({
    title: 'Contact',
    description: "Let's connect — reach out via any platform or send a direct message.",
  });
};
...
const DIRECT_CONTACTS = [
  {
    label: 'Email',
    value: 'aniketadhav2006@gmail.com',
    ...
    <Section className={styles.contact}>
      ...
      <div className={styles.leftPanel}>
        <div className={styles.leftInner}>
          ...
          <div className={styles.panelTag}>Get in touch</div>
          <h1 className={styles.panelHeading}>
            Let&apos;s <span className={styles.panelAccent}>Connect</span>
          </h1>
            ...
            {DIRECT_CONTACTS.map((c, i) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={e => { e.preventDefault(); handleCopy(c.value.replace(/\s/g, ''), i); }}
          ...
          <div className={styles.socialGrid}>
            {SOCIAL_LINKS.map((s, i) => (
              ...
              >
                <span className={styles.socialCardGlow} />
                <span className={styles.socialIcon}>{s.icon}</span>
                <div className={styles.socialBody}>
                  <span className={styles.socialLabel}>{s.label}</span>
                  <span className={styles.socialHandle}>{s.handle}</span>
                </div>
                <svg className={styles.socialArrow} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14">
              ...
              <Transition unmount in={!sending && actionData?.errors} timeout={msToNum(tokens.base.durationM)}>
                {({ status: errorStatus, nodeRef }) => (
                  <div
                    ...
                    style={cssProps({ height: errorStatus ? errorRef.current?.offsetHeight : 0 })}
                  >
